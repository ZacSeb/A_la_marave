...
//
//    @Test
//    public void ActionWeaponMaster(){
//        Hero hero = new Hero();
//        assertEquals(hero.getLevel(),1);
//        hero.setPvCurrent(10);
//        assertEquals(hero.getPvCurrent(),10,0.00001);
//        WeaponMaster weaponMaster = new WeaponMaster();
//        weaponMaster.action(hero);
//        assertEquals(hero.getLevel(),1);
//        assertEquals(hero.getPvCurrent(),11,0.00001);
//    }
}
